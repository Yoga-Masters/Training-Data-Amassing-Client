...
tdb.ref("frames").on("value", function (snap) {
...
tdb.ref("types").on("value", snap => {
    ...
    for (const key in snap.val()) {
        ...
        option.text = snap.val()[key].toUpperCase();
        option.value = key;
